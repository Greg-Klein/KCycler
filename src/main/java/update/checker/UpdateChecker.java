...
public class UpdateChecker {
    ...
    public static String checkVersion(PluginDescriptionFile pdfFile){
    	...
    	List<String> versionURL = readURL("http://www.mrkold.fr/pluginsversions/kcycler.txt");
    	...
    	String noupd = "";
    	String upd = ChatColor.AQUA + "[" + pdfFile.getName() + "] " + ChatColor.GREEN + "New version available! (v"+ lVersion + ")";
